...
namespace MetallicBlueDev.EntityGate.Core
{
    ...
    internal class EntityGateTracking
    {
        ...
        internal IEntityObjectIdentifier GetMainEntity()
        {
            ...
            {
                throw new EntityGateException(Resources.InvalidMainEntity);
            }
        ...
        internal void MarkEntity(object entity, EntityState state, bool isMainEntity)
        {
            ...
            {
                throw new EntityGateException(string.Format(CultureInfo.CurrentCulture, Resources.MustImplementInterface, entity, nameof(IEntityObjectIdentifier)));
            }
        ...
        private void Mark(IEntityObjectIdentifier entity, EntityState state, bool isMainEntity)
        {
            switch (state)
            {
                ...
                default:
                {
                    throw new EntityGateException(string.Format(CultureInfo.InvariantCulture, Resources.InvalidEntityStateForTracking, state, entity));
                }
            }
        }
