...
namespace MetallicBlueDev.EntityGate.Core
{
    ...
    /// </summary>
    [Serializable()]
    public abstract class EntityGateCore<TEntity, TContext> : IEntityGateObject
      ...
      where TContext : DbContext
    {
        ...
        internal EntityGateCore(TEntity externalEntity = null, string connectionName = null)
        {
            Token = new EntityGateToken();
            Configuration = new ClientConfiguration(this);
        ...
        public IEntityObjectIdentifier Delete(IEntityObjectIdentifier entity)
        {
            ...
            if (!HasEntityType() && !provider.HasCurrentEntityType())
            {
                FireSetEntityObject(entity);
                entity = this.entity;
            }
        ...
        public object GetFieldValue(string fieldName)
        {
            ...
            if (HasEntityObject && provider != null && provider.HasCurrentEntityType())
            {
                value = PocoHelper.GetFieldValue(entity, provider.GetCurrentEntityType(), fieldName);
            }
        ...
        {
            var name = provider != null && provider.HasCurrentEntityType()
                ? provider.GetCurrentEntityType().Name
        ...
        private EntityGateProvider<TContext> GetNewProvider()
        {
            ...
            if (HasEntityType())
            {
                newProvider.SetCurrentEntityType(typeof(TEntity));
            }
            else if (HasEntityObject)
            {
                newProvider.SetCurrentEntityType(entity.GetType());
            }
        ...
        {
            if (Configuration.CanUseLogging)
            {
                Configuration.Log(string.Format(CultureInfo.InvariantCulture, Resources.NewAttempt, Token.NumberOfAttempts, Configuration.MaximumNumberOfAttempts, Configuration.Timeout));
                Configuration.Log(string.Format(CultureInfo.InvariantCulture, Resources.Query, Token.SqlStatement));
            }
        }
        ...
        private void LogNoKeyFound()
        {
            if (Configuration.CanUseLogging)
            {
                Configuration.Log(string.Format(CultureInfo.InvariantCulture, Resources.EntityKeyNotFound, entity, entity.GetType().Name));
            }
        }
        ...
        private void LogSave()
        {
            if (Configuration.CanUseLogging)
            {
                ...
                {
                    Configuration.Log(string.Format(CultureInfo.InvariantCulture, Resources.DeletingEntity, GetTableName(), GetFriendlyName()));
                }
                else
                {
                    Configuration.Log(string.Format(CultureInfo.InvariantCulture, Resources.SavingEntityInState, GetTableName(), GetFriendlyName(), state.ToString()));
                }
            }
        }
        ...
        private void LogSaveError()
        {
            if (Configuration.CanUseLogging)
            {
                Configuration.Log(string.Format(CultureInfo.InvariantCulture, Resources.FailedToExecuteCommand, "Save", GetTableName(), GetFriendlyName()));
            }
        }
        ...
        private void LogLoad(object keyValue)
        {
            if (Configuration.CanUseLogging)
            {
                Configuration.Log(string.Format(CultureInfo.InvariantCulture, Resources.LoadingEntity, GetTableName(), keyValue ?? GetFriendlyName()));
            }
        }
        ...
        private void LogLoadError()
        {
            if (Configuration.CanUseLogging)
            {
                Configuration.Log(string.Format(CultureInfo.InvariantCulture, Resources.FailedToExecuteCommand, "Load", GetTableName(), GetFriendlyName()));
            }
        }
        ...
        private void LogEntityKeyNotFound(object keyValue)
        {
            if (Configuration.CanUseLogging)
            {
                Configuration.Log(string.Format(CultureInfo.InvariantCulture, Resources.EntityKeyNotFound, GetTableName(), keyValue ?? provider.GetModelName()));
            }
        }
        ...
        private void LogList()
        {
            if (Configuration.CanUseLogging)
            {
                Configuration.Log(string.Format(CultureInfo.InvariantCulture, Resources.ListEntity, GetTableName(), GetFriendlyName()));
            }
        }
        ...
        private void LogListError()
        {
            if (Configuration.CanUseLogging)
            {
                Configuration.Log(string.Format(CultureInfo.InvariantCulture, Resources.FailedToExecuteCommand, "List", GetTableName(), GetFriendlyName()));
            }
        }
        ...
        private void LogNewEntityError()
        {
            if (Configuration.CanUseLogging)
            {
                Configuration.Log(string.Format(CultureInfo.InvariantCulture, Resources.FailedToExecuteCommand, "NewEntity", GetTableName(), GetFriendlyName()));
            }
        }
        ...
        private void FireSetEntityObject(IEntityObjectIdentifier entity)
        {
            ...
            {
                throw new EntityGateException(Resources.UnableToHandleEntityType);
            }
        ...
        private IEntityObjectIdentifier MarkAs(IEntityObjectIdentifier entity, EntityState targetState)
        {
            ...
            {
                throw new EntityGateException(string.Format(CultureInfo.InvariantCulture, Resources.FailedToExecuteCommand, $"Mark as {targetState}", entity, entity.GetContentInfo()), ex);
            }
        ...
        {
            var newEntity = ReflectionHelper.MakeInstance<TEntity>(provider.GetCurrentEntityType());
        ...
        private object GetEntityIdentifier(object keyValue)
        {
            if (keyValue == null)
            {
                if (!HasEntityObject)
                {
                    throw new EntityGateException(string.Format(CultureInfo.InvariantCulture, Resources.EntityKeyNotFound, GetTableName(), provider.GetModelName()));
                }
        ...
        private bool LoadEntity(object keyValue)
        {
            ...
            while (ExecutionAllowed())
            {
                ...
                catch (Exception ex)
                {
                    ...
                    {
                        this.LogException(ex);
                        throw new TransactionCanceledEntityGateException(string.Format(CultureInfo.InvariantCulture, Resources.UnableToExecuteCommand, this.GetType().Name, Token.NumberOfAttempts), ex);
                    }
                }
            }
        ...
        private IEnumerable<TEntity> LoadEntitySet()
        {
            ...
            while (ExecutionAllowed())
            {
                ...
                try
                {
                    rslt = provider.MakeObjectSet<TEntity>();
                    break;
                }
                catch (Exception ex)
                {
        ...
        {
            return ReflectionHelper.IsValidEntityType(typeof(TEntity));
        }
        ...
        private void AppendEntity(TEntity nextEntity)
        {
            if (nextEntity == null)
            {
                throw new EntityGateException(Resources.InvalidEntity);
            }
        ...
        private void AffectEntity(TEntity externalEntity)
        {
            ...
            provider.SetCurrentEntityType(externalEntity.GetType());
            entity = (TEntity)provider.GetManagedOrPocoEntity(externalEntity, provider.GetCurrentEntityType());
