    ...
    internal class ReflectionHelper
    {
        ...
        internal static TObject MakeInstance<TObject>(Type type, params object[] args)
        {
            ...
            if (type != null)
            {
                ...
                {
                    throw new ReflectionEntityGateException(string.Format(CultureInfo.InvariantCulture, Resources.UnableToCreateObject, typeof(TObject).Name, type?.Name), ex);
                }
            }

            if (rslt == null)
            {
                throw new ReflectionEntityGateException(string.Format(CultureInfo.InvariantCulture, Resources.UnableToCreateObject, typeof(TObject).Name, type?.Name));
            }
        ...
        internal static string GetPropertyName<TObject>(Expression<Func<TObject, object>> exp)
        {
            ...
            {
                throw new ReflectionEntityGateException(string.Format(CultureInfo.InvariantCulture, Resources.UnableToGetPropertyName, exp.ToString()));
            }
        ...
        internal static void BuiltContentInfo(object source, StringBuilder content)
        {
            if (source != null)
            {
                ...
                {
                    throw new ReflectionEntityGateException(string.Format(CultureInfo.InvariantCulture, Resources.UnableToObtainInformationContainedInEntity, sourceType.Name), ex);
                }
            }
        }

        /// <summary>
        /// Returns the corresponding SQL error.
        /// If no SQL error found, return <code>null</code>.
        /// </summary>
        /// <param name="ex">Internal error</param>
        /// <returns></returns>
        internal static SqlException GetSqlException(Exception ex)
        {
        ...
        /// <returns></returns>
        internal static bool IsValidEntityType(Type entityType)
        {
