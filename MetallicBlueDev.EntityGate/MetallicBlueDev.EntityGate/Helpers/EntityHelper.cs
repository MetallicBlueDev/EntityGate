...
namespace MetallicBlueDev.EntityGate.Helpers
{
    ...
    public static class EntityHelper
    {
        ...
        public static EntityGateContext<TContext> GetEntityGate<TContext>(Type entityType, object entityIdentifier) where TContext : DbContext
        {
            ...
            {
                throw new EntityGateException(string.Format(CultureInfo.InvariantCulture, Resources.UnableToLoadEntityKey, gate.GetFriendlyName(), entityIdentifier != null ? entityIdentifier.ToString() : "null"));
            }
        ...
        public static TEntity CheckEntityType<TEntity>(IEntityObjectIdentifier entity) where TEntity : class, IEntityObjectIdentifier
        {
            ...
            {
                throw new EntityGateException(string.Format(CultureInfo.InvariantCulture, Resources.InvalidEntityType, entity != null ? entity.GetType().ToString() : "null"));
            }
