...
namespace MetallicBlueDev.EntityGate.Helpers
{
    ...
    internal static class PocoHelper
    {
        ...
        /// <returns></returns>
        internal static T GetPocoEntity<T>(T entity, Type contextEntityType = null, ArrayList circularReferences = null, bool withDataRelation = false) where T : class
        {
            T result;
        ...
        internal static object GetFieldValue(IEntityObjectIdentifier entity, Type entityType, string fieldName)
        {
            ...
            if (entity != null && fieldName.IsNotNullOrEmpty() && ReflectionHelper.IsValidEntityType(entityType))
            {
