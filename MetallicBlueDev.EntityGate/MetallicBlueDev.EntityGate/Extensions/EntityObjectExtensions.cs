...
namespace MetallicBlueDev.EntityGate.Extensions
{
    ...
    public static class EntityObjectExtensions
    {
        ...
        /// <returns></returns>
        public static TEntity CloneEntity<TEntity>(this TEntity source, bool withDataRelation = false) where TEntity : class, IEntityObjectIdentifier
        {
            TEntity result = null;

            if (source != null)
            {
                var contextEntityType = ObjectContext.GetObjectType(source.GetType());
                result = ReflectionHelper.CloneEntity(source, contextEntityType, withDataRelation);
            }
        ...
        public static TEntity Reload<TEntity>(this TEntity entity) where TEntity : class, IEntityObjectIdentifier
        {
            ...
            if (entity != null)
            {
                ...
                if (!gate.Load())
                {
                    throw new EntityGateException(string.Format(CultureInfo.InvariantCulture, Resources.UnableToLoadEntityKey, gate.GetFriendlyName(), entity.Identifier));
                }
        ...
        {
            return entity != null
                && ReflectionHelper.IsValidEntityType(entity.GetType());
        }
    }
}
